...
extension NSColor
{
    /// Create a NSColor with the lower 24-bits of the passed integer. Alpha is set to 1.0.
    ///
    ...
    /// Create a NSColor with the passed hex string.
    ///
    /// - Note:
    ...
    /// Return the value of the instance NSColor as a hex string.
    ///
    /// - Parameters:
    ...
    public static func MakeRandomColor(_ ColorType: RandomColorTypes = .AnyColor) -> NSColor
    {
        var RRed: Double = 0.0
        ...
        return NSColor(red: CGFloat(RRed), green: CGFloat(RGreen), blue: CGFloat(RBlue), alpha: 1.0)
    }
